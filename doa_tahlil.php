<?php
$data = file_get_contents('data/doa-tahlil.json');
                ...
                <div class=" w-full mb-10">
                    <div class="mb-16 lg:mb-0">
                        ...
                        <div class="flex-row justify-end mb-6">
                            <h2 class="arabic text-end text-3xl sm:mt-0 mt-6 text-gray-900 sm:text-4xl mb-6">
                                <?= $result["arab"]; ?>
                            </h2>
                            <p class="text-black text-end text-base md:text-lg">
                                Arntinya : "
                                <?= $result["id"]; ?>"
                            </p>
                        </div>
