...
$url = 'https://raw.githubusercontent.com/mikqi/dzikir-counter/master/www/asmaul-husna.json';
    ...
    <section class="text-gray-600 body-font flex justify-center items-center">
        <div class="container px-5 py-4 mx-auto">
            <div class="flex flex-wrap -m-4 text-center" id="surahList">
                ...
                <?php foreach ($data as $asmaulHusna) { ?>
                        ...
                        <div
                            ...
                            <div>
                                <h2 class="text-gray-900 text-lg font-bold text-start">
                                    <?php echo $asmaulHusna['urutan']; ?>
                                </h2>
                                <h2 class="text-gray-900 text-lg font-bold">
                                    <?php echo $asmaulHusna['latin']; ?>
                                </h2>
                                <p class="text-sm mb-6 font-semibold text-gray-400">Artinya
                                    <?php echo $asmaulHusna['arti'] ?>
                                </p>

                            </div>
                            <div>
                                <h1 class="text-orange-600 text-4xl arabic">
                                    <?php echo $asmaulHusna['arab']; ?>
                                </h1>
                            </div>
                        </div>
                    </div>
